...
class _ProfileState extends State<Profile> {
  ...
  getFollowers() async{
    QuerySnapshot snapshot = await followersRef.document(widget.profileId).collection('userFollowers')
     .getDocuments();
    setState(() {
...
.collection('userFollowing').getDocuments();
  ...
  buildProfileButton() {
    //if viewing our own profile then there should be edit profile button
