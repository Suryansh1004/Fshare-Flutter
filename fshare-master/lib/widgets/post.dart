...
class _PostState extends State<Post> {
  ...
  //To delete post, ownerId and currentUserId must be equal , so they can be used interchangeably
  deletePost() async{
   //delete post itself
  ...
  addLikeToActivityFeed(){
    //add a notification to postOwner's activity feed only if comment made by other user(to avoid notification forr own liked post)
